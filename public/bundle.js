...
/***/ function(module, exports, __webpack_require__) {
	...
	var _allRecipesData = __webpack_require__(164);

	var _allRecipesData2 = _interopRequireDefault(_allRecipesData);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recipeList = __webpack_require__(161);

	var _recipeList2 = _interopRequireDefault(_recipeList);

	var _AddRecipe = __webpack_require__(163);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'jumbotron text-center', 'background-image': 'https://njbrowne.files.wordpress.com/2014/09/bigstock-rustic-kitchen-background-51523612.jpg' },
	          _react2.default.createElement(
	            'h1',
	            null,
	            'Welcome to CookShow'
	          ...
	          _react2.default.createElement(
	            'h4',
	            null,
	            '"Where all your recipes stay in one Kitchen... if I wasn\'t clear I meant this Kitchen"'
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'a',
	            { onClick: this.onClickRecipes.bind(this), href: '#', className: 'btn btn-primary' },
	            'Your Recipes'
	          ),
	          _react2.default.createElement(
	            'a',
	            { onClick: this.onClickAdd.bind(this), href: '#', className: 'btn btn-primary' },
	            'Add a Recipe'
	          ),
	          this.state.showRecipes ? _react2.default.createElement(_recipeList2.default, { list: this.state.recipes }) : _react2.default.createElement(_AddRecipe2.default, { handleInputChange: this.handleInputChange.bind(this) })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recipeEntry = __webpack_require__(162);
	...
	var RecipeList = function RecipeList(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    list.map(function (recipe) {
	      return _react2.default.createElement(_recipeEntry2.default, { recipe: recipe });
	    })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeEntry = function (_React$Component) {
	  _inherits(RecipeEntry, _React$Component);

	  function RecipeEntry(props) {
	    _classCallCheck(this, RecipeEntry);

	    return _possibleConstructorReturn(this, (RecipeEntry.__proto__ || Object.getPrototypeOf(RecipeEntry)).call(this, props));
	  }

	  _createClass(RecipeEntry, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "col-sm-3" },
	          _react2.default.createElement("img", { className: "img-responsive col-md-12 margin-center", src: this.props.recipe.photoUrl, alt: "" })
	        ),
	        _react2.default.createElement(
	          "div",
	          { className: "recipe-body col-md-8" },
	          _react2.default.createElement(
	            "h4",
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "a",
	              { href: this.props.recipe.recipeUrl },
	              "Go to Recipe"
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddRecipe = function (_React$Component) {
	  ...
	  function AddRecipe(props) {
	    ...
	    _this.handleRecipeChange = _this.handleRecipeChange.bind(_this);
	    _this.handlePhotoChange = _this.handlePhotoChange.bind(_this);
	  ...
	  _createClass(AddRecipe, [{
	    ...
	    key: 'handleRecipeChange',
	    value: function handleRecipeChange(e) {
	      this.setState({ recipeUrl: e.target.value });
	    }
	  }, {
	    key: 'handlePhotoChange',
	    value: function handlePhotoChange(e) {
	      this.setState({ photoUrl: e.target.value });
	    }
	  }, {
	    key: 'onSubmit',
	    value: function onSubmit() {
	      //allRecipes.push(this.state);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'form',
	        { className: 'form', action: '/addrecipe', method: 'post', onSubmit: this.onSubmit },
	        _react2.default.createElement(
	          'div',
	        ...
	        _react2.default.createElement(
	          'button',
	          { className: 'btn text-right', type: 'submit' },
	          'Submit'
	        )
	      );
	    }
...
/***/ function(module, exports) {
	...
	var allRecipes = [{ name: 'Paprika Chicken', description: 'While this is a pretty straightforward grilled chicken recipe, the vinaigrette at the end was a last minute touch that worked out nicely. I really like oil and vinegar-based sauces on grilled meats. They work beautifully with the smoky, caramelized exterior.', recipeUrl: 'http://allrecipes.com/recipe/221093/good-frickin-paprika-chicken/print/?recipeType=Recipe&servings=6', photoUrl: 'http://kingofwallpapers.com/chicken/chicken-011.jpg' }, { name: 'Paprika Chicken', description: 'While this is a pretty straightforward grilled chicken recipe, the vinaigrette at the end was a last minute touch that worked out nicely. I really like oil and vinegar-based sauces on grilled meats. They work beautifully with the smoky, caramelized exterior.', recipeUrl: 'http://allrecipes.com/recipe/221093/good-frickin-paprika-chicken/print/?recipeType=Recipe&servings=6', photoUrl: 'http://kingofwallpapers.com/chicken/chicken-011.jpg' }];
